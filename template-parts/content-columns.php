	    ...
	    while ( have_rows('content') ) : the_row();
	        ...
	        if( get_row_layout() == 'one_column' ): ?>
	        	...
	        	<?php if (get_sub_field('parallax') ) : ?>
	        		<?php echo $before_parallax_prepend; ?><div <?php if ($section_id != null) { echo 'id="' . $section_id . '" ' ; } ?>class="parallax-window" data-parallax="scroll" data-image-src="<?php echo wp_get_attachment_image_url(get_sub_field('parallax_image'), $size = 'full'); ?>"><?php echo $before_parallax_append; ?>
						<div class="row">
	        	...
	        	<?php else : ?>
	        		<section <?php if ($section_id != null) { echo 'id="' . $section_id . '" ' ; } ?>class="<?php echo $background; ?>">
		        		<div class="row">
							...
							<?php endif; ?>			        		
		        			<div class="large-6 medium-6 columns <?php echo drum_animate('1', $row_counter); ?>">
		        				<?php echo get_sub_field('column_1'); ?>
		        				<?php echo drum_animate('1', $row_counter, true); ?>
		        			</div>
		        			<div class="large-6 medium-6 columns <?php echo drum_animate('2', $row_counter); ?>">
		        				<?php echo get_sub_field('column_2'); ?>
	        ...
	        <?php elseif( get_row_layout() == 'three_columns' ): ?>
				...
				<section <?php if ($section_id != null) { echo 'id="' . $section_id . '" ' ; } ?>class="<?php echo $background; ?>">
					<div class="row">
						...
						<?php endif; ?>						
		        		<div class="large-4 medium-4 columns <?php echo drum_animate('1', $row_counter); ?>">
		        			<?php echo get_sub_field('column_1'); ?>
		        			<?php echo drum_animate('1', $row_counter, true); ?>
		        		</div>
		        		<div class="large-4 medium-4 columns <?php echo drum_animate('2', $row_counter); ?>">
		        			<?php echo get_sub_field('column_2'); ?>
		        			<?php echo drum_animate('2', $row_counter, true); ?>
		        		</div>
		        		<div class="large-4 medium-4 columns <?php echo drum_animate('3', $row_counter); ?>">
	        ...
	        <?php elseif( get_row_layout() == 'four_columns' ): ?>
	        	...
	        	<section <?php if ($section_id != null) { echo 'id="' . $section_id . '" ' ; } ?>class="<?php echo $background; ?>">
		        	<div class="row">
						...
						<?php endif; ?>			        	
		        		<div class="large-3 medium-3 columns <?php echo drum_animate('1', $row_counter); ?>">
		        			<?php echo get_sub_field('column_1'); ?>
		        			<?php echo drum_animate('1', $row_counter, true); ?>
		        		</div>
		        		<div class="large-3 medium-3 columns <?php echo drum_animate('2', $row_counter); ?>">
		        			<?php echo get_sub_field('column_2'); ?>
		        			<?php echo drum_animate('2', $row_counter, true); ?>
		        		</div>
		        		<div class="large-3 medium-3 columns <?php echo drum_animate('3', $row_counter); ?>">
		        			<?php echo get_sub_field('column_3'); ?>
		        			<?php echo drum_animate('3', $row_counter, true); ?>
		        		</div>
		        		<div class="large-3 medium-3 columns <?php echo drum_animate('4', $row_counter); ?>">
	        ...
	        <?php elseif( get_row_layout() == 'right_sidebar' ): ?>
	        	...
	        	<section <?php if ($section_id != null) { echo 'id="' . $section_id . '" ' ; } ?>class="<?php echo $background; ?>">
		        	<div class="row">
						...
						<?php endif; ?>			        	
		        		<div class="large-8 medium-8 columns <?php echo drum_animate('1', $row_counter); ?>">
	        ...
	        <?php elseif( get_row_layout() == 'left_sidebar' ): ?>
				...
				<section <?php if ($section_id != null) { echo 'id="' . $section_id . '" ' ; } ?>class="<?php echo $background; ?>">
					<div class="row">
		        		...
		        		<div class="large-8 medium-8 columns <?php echo drum_animate('2', $row_counter); ?>">
		        			<?php echo get_sub_field('wide_column'); ?>
		        			<?php echo drum_animate('2', $row_counter, true); ?>
		        		</div>
					</div> <!-- row -->
		        		...
		        		<div class="large-12 columns <?php echo drum_animate('1', $row_counter); ?>">
							...
							<?php if(get_sub_field('accordion')): ?>
								<?php while(has_sub_field('accordion')): ?>
									<li>
										<a><?php the_sub_field('section_title'); ?></a>
		        		...
		        		<div class="large-12 columns <?php echo drum_animate('1', $row_counter); ?>">
			        		<div class="tabs-container">
								...
								<?php if(get_sub_field('tabs')): ?>
									...
									<?php while(has_sub_field('tabs')): ?>
										<div><div class="tab-content-inner"><?php the_sub_field('tab_content'); ?></div></div>
									<?php endwhile; ?>
